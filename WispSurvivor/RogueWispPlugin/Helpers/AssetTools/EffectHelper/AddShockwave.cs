...
namespace Rein.RogueWispPlugin.Helpers
{
    ...
    {
        private static Dictionary<GameObject, UInt32> shockwaveCounter = new Dictionary<GameObject, UInt32>();
        internal static ParticleSystem AddShockwave( GameObject mainObj, WispSkinnedEffect skin, MaterialType matType, Int32 count, Single lifetime, Single speed, Single size )
        {
            if( !shockwaveCounter.ContainsKey( mainObj ) ) shockwaveCounter[mainObj] = 0u;
            var obj = new GameObject( "Shockwave" + shockwaveCounter[mainObj]++ );
