...
namespace RogueWispPlugin
{
    internal partial class Main
    {
        ...
        {
            var obj = new GameObject("",typeof(NetworkIdentity)).InstantiateClone("AWPrimaryProjectile", true );
        ...
        {
            var obj = new GameObject("",typeof(NetworkIdentity)).InstantiateClone("AWUtilityProjectile", true );
