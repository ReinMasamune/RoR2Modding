...
namespace RogueWispPlugin
{
    internal partial class Main
    {
        ...
        {
            var obj = new GameObject().InstantiateClone("LeechOrb", false);
        ...
        {
            var obj = new GameObject().InstantiateClone( "UtilityChargeEffect", false );
        ...
        {
            var obj = new GameObject().InstantiateClone( "PrimaryProjGhost", false );
        ...
        {
            var obj = new GameObject().InstantiateClone( "SecondaryExplosionEffect", false );
            var effComp = obj.AddComponent<EffectComponent>();
            effComp.positionAtReferencedTransform = false;
            effComp.parentToReferencedTransform = false;
        ...
        {
            var obj = new GameObject().InstantiateClone( "SecondaryPredictionEffect", false );
        ...
        {
            var obj = new GameObject().InstantiateClone( "PrimaryExplosionEffect", false );
            var effComp = obj.AddComponent<EffectComponent>();
            effComp.positionAtReferencedTransform = false;
            effComp.parentToReferencedTransform = false;
            effComp.applyScale = true;
        ...
        {
            var obj = new GameObject().InstantiateClone( "PrimaryChargeEffect", false );
