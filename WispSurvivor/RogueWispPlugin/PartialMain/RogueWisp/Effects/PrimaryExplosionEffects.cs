...
//    {
//        partial void RW_PrimaryExplosionEffects() => this.Load += this.RW_CreatePrimaryExplosionEffects;
...
//            GameObject obj = baseFX.ClonePrefab("PrimaryExplosion"+skinIndex.ToString(), true);
