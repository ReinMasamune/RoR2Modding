...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
		...
		internal static Boolean MatchAssetIndexType( Type assetType, Type enumType )
		{
            return AssetsCore.indexAssociations.TryGetValue( assetType, out Type type ) ? enumType == type : false;
        }
