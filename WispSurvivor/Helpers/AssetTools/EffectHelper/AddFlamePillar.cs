...
namespace RogueWispPlugin.Helpers
{
    internal static partial class EffectHelper
    {
        ...
        internal static ParticleSystem AddFlamePillar( GameObject mainObj, WispSkinnedEffect skin, MaterialType matType, Single height, Single radius, Single lifetime )
        {
            ...
            psMain.startSizeX = new ParticleSystem.MinMaxCurve( calcRad * 0.75f, calcRad * 1.25f );
            psMain.startSizeY = new ParticleSystem.MinMaxCurve( 0.8f, 1.2f );
            psMain.startSizeZ = calcHeight;
            ...
            psr.mesh = AssetLibrary<Mesh>.i[MeshIndex.Spiral1];
