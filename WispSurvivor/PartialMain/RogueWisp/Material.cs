...
namespace RogueWispPlugin
{
    ...
    internal partial class Main
    {
        ...
        internal static Gradient[][] armorGradients = new Gradient[8][];
        internal static Gradient[] electricGradients = new Gradient[8];
        internal static Color[] fireColors = new Color[8];
        internal static Texture2D[] fireTextures = new Texture2D[8];
        internal static Texture2D[][] armorTextures = new Texture2D[8][];
        ...
        {
            this.Load += this.RW_GenerateGradients;
            this.Load += this.RW_GenerateTextures;
            this.Load += this.RW_GenerateMaterials;
        }

        private void RW_GenerateMaterials()
        {
            Material[] baseMats = this.GetBaseMaterials();
        ...
        private void RW_GenerateGradients()
        {
        ...
        private Material[] GetBaseMaterials()
        {
            ...
            //matAncientWispFire
            mats[0] = this.RW_body.GetComponent<ModelLocator>().modelTransform.GetComponent<CharacterModel>().baseParticleSystemInfos[0].renderer.material;
