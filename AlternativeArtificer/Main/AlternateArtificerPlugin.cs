namespace AlternativeArtificer.Main
{
    using System;
    ...
    using AlternativeArtificer.Properties;

    using BepInEx.Logging;

#pragma warning disable CA2243 // Attribute string literals should parse correctly
    [BepInEx.BepInDependency(AssemblyLoad.guid, BepInEx.BepInDependency.DependencyFlags.HardDependency)]
    [BepInEx.BepInPlugin(guid, pluginName, Properties.Info.ver)]
#pragma warning restore CA2243 // Attribute string literals should parse correctly
    public class AlternateArtificerPlugin : ReinCore.CorePlugin
    {
        internal const String guid = "Rein.AlternateArtificer";
        internal const String pluginName = "Alternate Artificer";
        ...
        private static void InternalLog(LogLevel level, System.Object data)
        {
            ...
            switch(level)
            {
                ...
                case LogLevel.Fatal:
                    ...
                    break;
                default:
                    AlternateArtificerPlugin.logSource.Log(LogLevel.Info, data);
                    break;
            ...
            if(log)
            {
                AlternateArtificerPlugin.logSource.Log(level, data);
            }
        }
        ...
        private static void InternalLogL(LogLevel level, System.Object data, String member, Int32 line)
        {
            ...
            switch(level)
            {
                ...
                case LogLevel.Fatal:
                    ...
                    break;
                default:
                    AlternateArtificerPlugin.logSource.Log(LogLevel.Info, String.Format("{0}; Line:{1}: {2}", member, line, data));
                    break;
            ...
            if(log)
            {
                AlternateArtificerPlugin.logSource.Log(level, String.Format("{0}; Line:{1}: {2}", member, line, data));
            }
        }
    }
    #endregion
