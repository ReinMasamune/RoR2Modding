...
namespace RogueWispPlugin
{
    ...
    internal partial class Main
    {
        public class PrepHeatwave : BaseState
        {
            ...
            public static Single noStockSpeedMult = 0.35f;
            ...
            private void GetTarget()
            {
                ...
                if( Util.CharacterRaycast( base.outer.gameObject, r, out rh, maxRange, LayerIndex.world.mask | LayerIndex.entityPrecise.mask, QueryTriggerInteraction.UseGlobal ))
                {
                    ...
                    if( Util.CharacterRaycast( base.outer.gameObject, r, out rh, maxRange, LayerIndex.world.mask, QueryTriggerInteraction.UseGlobal ))
                    {
