...
namespace Sniper.Modules
{
    internal static class SkillFamiliesModule
    {
        ...
        {
            if( ammoSkills == null ) SkillsModule.CreateAmmoSkills();
        ...
        {
            if( passiveSkills == null ) SkillsModule.CreatePassiveSkills();
        ...
        {
            if( primarySkills == null ) SkillsModule.CreatePrimarySkills();
        ...
        {
            if( secondarySkills == null ) SkillsModule.CreateSecondarySkills();
        ...
        {
            if( utilitySkills == null ) SkillsModule.CreateUtilitySkills();
        ...
        {
            if( specialSkills == null ) SkillsModule.CreateSpecialSkills();
            return FromList( specialSkills );
        }

        private static SkillFamily FromList( List<SkillDef> defs )
        {
            var defaultSkill = defs[0];
            var variants = defs.GetRange(1, defs.Count - 1).Select( (def) => (def,"") ).ToArray();
