namespace AppDomainTests.Mod
{
    ...
    [BepInEx.BepInPlugin( "com.Rein.AppDomainTest", "AppDomainTest", "1.0.0.0" )]
    [BepInEx.BepInDependency( AppDomainTests.Properties.AssemblyLoad.guid )]
