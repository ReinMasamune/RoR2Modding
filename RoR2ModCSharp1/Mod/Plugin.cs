namespace RoR2ModCSharp1.Mod
{
    ...
    [BepInPlugin( "com.Rein.EmitTest", "EmitTest", Properties.Info.ver )]
    public class Plugin : ReinCore.CorePlugin
    {
        protected override void Init()
        {
            ...
            Log.Warning( typeof( System.Reflection.Emit.ParameterBuilder ).FullName );
        }
